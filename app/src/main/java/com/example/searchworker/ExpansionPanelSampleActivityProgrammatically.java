...
import static com.example.searchworker.Utils.dpToPx;
...
public class ExpansionPanelSampleActivityProgrammatically extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_expansion_panel_sample_programmatically);
    ...
    private ExpansionLayout createExpansionLayout() {
        ...
        layout.addView(LayoutInflater.from(this).inflate(R.layout.activity_expansion_panel_sample, layout, false));
